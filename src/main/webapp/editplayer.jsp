...
<header>
  <h1><marquee direction="left" scrollamount="13"> Welcome to the Player edit page for IPL Auction 2023-2024 Session</marquee></h1>
</header>
...
<a href="playerhome.jsp" class="back-button">Back</a>
</body>
</html>